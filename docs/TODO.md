...
| `design/` handoff bundle ulazi u `fallow` analizu (vendored prototip, `support.js` + `_ds_bundle.js`) i diže broj nalaza | `design/Skincare_Platform_Design-handoff/` | otvoreno — dodati u fallow ignore |
