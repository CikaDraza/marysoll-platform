...
| B-T1-0.5 | ★ Service-owned Intake | ✅ kod · ⏳ migracija čeka | Odluka o zahtevu preseljena sa platformske kategorije na uslugu; jedan checkbox u obrascu. Server odbija zahtev na usluzi koja ga ne prima. `CATEGORY_MAP.requiresIntake` više nije authority. **Backfill dodiruje 2 salona i nije pokrenut.** | [PANTA-SERVICE-INTAKE.md](PANTA-SERVICE-INTAKE.md) |
