...
| 5 | ★ T3 Booking Engine CORE | ⬜ nije počet | Specifikacija je zaključana; slede `BookingReservation` kao kanonski occupancy, `BookingDayLock`, idempotencija, quote snapshot, conflict recovery, `BookingFacts` i transactional outbox. | [PANTA-T3-BOOKING-ENGINE.md](PANTA-T3-BOOKING-ENGINE.md) |
