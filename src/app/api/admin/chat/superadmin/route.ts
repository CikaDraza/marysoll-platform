...
import { notifySuperAdminsOfChatMessage } from "@/lib/superAdminChat/notify";
...
export async function POST(req: NextRequest) {
  ...
  // Zvonce + push + throttle-ovan email superadminima (nikad ne baca).
  await notifySuperAdminsOfChatMessage({
    tenantId: decoded.tenantId!,
    senderTenantUserId: decoded.tenantUserId,
    content: content ?? "",
