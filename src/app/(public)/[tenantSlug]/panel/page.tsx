 ...
 *
 * Koristi ClientPanelLayout (sidebar + header) umjesto starog top header+tabs dizajna.
 * Tab stanje je synced sa URL query paramom (?tab=...) za NotificationBell navigaciju.
 */
"use client";
...
export default function ClientPanelPage() {
  ...
  // Sync when URL changes (NotificationBell navigates with ?tab=...)
  useEffect(() => {
