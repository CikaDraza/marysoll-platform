...
const FEATURE_LABELS: Partial<Record<keyof PlanFeatures, string>> = {
  ...
  loyaltyCore: "Growth Studio — program nagrađivanja",
  loyaltySystem: "Growth Studio — napredni loyalty (tieri, referral)",
  loyaltyRevenue: "Growth Studio — dynamic pricing i Happy Hour",
