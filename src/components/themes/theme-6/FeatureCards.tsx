  ...
  items = [
    {
      ...
      description: "Over a decade of mastering the art of beauty and elegance",
      icon: "✦",
    },
    {
      title: "Premium Products",
      description: "Only the finest, salon-grade products for lasting results",
      icon: "◆",
    },
    {
      title: "Expert Masters",
      description: "Certified professionals passionate about their craft",
      image: "",
    },
    {
      title: "Hygiene First",
    ...
    },
    {
      ...
      description: "Tailored services designed around your unique style",
      icon: "◇",
    },
  ],
}: Props) {
          ...
          {items.map((item, idx) => (
            ...
            >
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-light text-[var(--foreground)]">
                  {item.title}
                </h3>
