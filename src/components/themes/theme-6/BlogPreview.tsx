...
export function Theme6BlogPreview({
  ...
  posts = [
    {
      title: "Summer Nail Trends and Color Ideas",
      excerpt: "Discover the hottest nail trends for summer.",
      image: "",
      slug: "#",
      category: "Trends",
    },
    {
      ...
      excerpt: "Expert tips and tricks to extend the life of your manicure.",
      image: "",
      slug: "#",
      category: "Tips",
    },
                ...
                <div className="aspect-[16/10] bg-white overflow-hidden">
                  {post.image ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-[#E8D5C4] to-[#D4B5A0] flex items-center justify-center">
                      <span className="text-[var(--muted)] text-sm font-mono text-center px-4">
                        [{post.title}]
                      </span>
                    </div>
                  )}
