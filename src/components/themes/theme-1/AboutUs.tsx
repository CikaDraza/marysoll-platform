...
export function Theme1AboutUs({ about }: Props) {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto grid grid-cols-1 lg:grid-cols-5 max-w-7xl">
        <div className="mx-auto lg:col-span-2 text-center">
          <h2 className="text-4xl lg:text-5xl mb-6 lg:mb-0 text-left font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">
