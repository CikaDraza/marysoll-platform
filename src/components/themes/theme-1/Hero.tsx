  ...
  return (
    <section className="bg-transparent mx-auto lg:pb-24">
      <div className="relative isolate px-4 pt-4">
        <div
          aria-hidden="true"
          className="absolute inset-x-0 top-40 lg:-top-40 -z-10 transform-gpu overflow-hidden blur-3xl"
        >
          <div
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-full">
          <div className="relative text-center">
            <div className="mt-16">
              <h1 className="text-[96px] lg:text-[200px] text-center text-(--primary-color) font-bold">
                {salon.name}
              </h1>
              {salon.description && (
              ...
              <dl className="flex flex-col gap-y-6 lg:gap-y-0 lg:flex-row justify-between items-center w-full">
                {(salon.street || salon.city) && (
                  <div className="relative pl-12 text-center lg:text-left">
                    ...
                    <dd className="text-sm text-(--primary-color)">
                      {salon.street}
                ...
                {salon.phone && (
                  <Link
                    ...
                    className="relative pl-12 text-center lg:text-left group"
                  >
                    <dt className="text-sm font-light text-(--secondary-color)">
                ...
                <div className="flex gap-4">
                  <dt className="border rounded-2xl px-4 py-2 text-base/7 font-light text-(--secondary-color) font-main-font text-left flex">
            ...
            <div className="mt-10 flex gap-4 justify-center">
              <Link
                href="/termini"
                className="px-7 py-3 bg-(--secondary-color) text-white font-semibold rounded-full hover:bg-(--primary-color) transition text-sm"
              >
                Zakaži termin
              </Link>
              <Link
                href="/usluge"
                className="px-7 py-3 border border-(--primary-color) text-(--primary-color) font-semibold rounded-full hover:bg-(--primary-color) hover:text-white transition text-sm"
              >
                Naše usluge
              </Link>
            </div>
