...
export function Theme2ImageGenerationSection() {
  ...
  const handleGenerate = useCallback(async () => {
    if (!prompt.trim()) { setError("Unesite opis."); return; }
  ...
  return (
    <section className="bg-gray-900 py-24 px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h2 className="text-3xl font-black text-white mb-4">AI Kreator izgleda</h2>
        <p className="text-gray-600 text-sm mb-8 max-w-md mx-auto">Opišite željeni makeup ili stil i naš AI će kreirati viziju za vas.</p>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-2xl min-h-48 flex items-center justify-center p-4">
          {generatedImage
            ...
            : <p className="text-gray-600 text-sm">{isLoading ? "Kreira se..." : "Ovde će se pojaviti generisana slika."}</p>
          }
        </div>
      </div>
    </section>
