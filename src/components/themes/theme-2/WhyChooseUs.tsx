  ...
  return (
    <section className="bg-gray-900 py-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-3xl font-black text-white mb-12">Zašto izabrati nas?</h2>
        <div className="space-y-3">
          {benefits.map(b => (
            <div key={b} className="flex items-center gap-4 p-4 bg-gray-800 rounded-xl border border-gray-700 hover:border-yellow-500/40 transition group">
              ...
              <span className="text-gray-200 font-medium text-sm">{b}</span>
            </div>
          ))}
        </div>
      </div>
