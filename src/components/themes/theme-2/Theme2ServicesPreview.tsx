          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            {services?.slice(0, 6).map((s, idx) => {
              ...
              return (
                <div
                  key={s._id}
                  className={`p-6 transition flex flex-col ${isOddCard ? "bg-black text-white hover:bg-(--primary-color)" : "bg-yellow-500 hover:bg-(--primary-color) text-black hover:text-white"} rounded-lg`}
                >
