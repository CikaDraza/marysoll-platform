...
export function Theme4AppointmentSection({
  tenantSlug,
  clientSlug,
  salon,
  services,
  ...
  return (
    <div id="booking" className="overflow-hidden bg-[#4C2D4A] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              <h2 className="mt-2 text-5xl font-semibold tracking-tight text-pretty text-white sm:text-6xl">
