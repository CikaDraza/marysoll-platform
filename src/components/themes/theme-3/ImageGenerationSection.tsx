  ...
  return (
    <section className="bg-[#F5EEE8] py-20 lg:py-28 px-6">
      <div className="max-w-2xl mx-auto text-center">
        <p className="text-[#C9A990] text-xs font-semibold tracking-[0.25em] uppercase mb-3">
          AI kreator
        </p>
        <h2 className="text-3xl font-light text-[#3D2B1F] mb-4">
          Kreiraj svoj izgled
        </h2>
        <p className="text-[#9E7E6E] text-sm mb-8 max-w-md mx-auto">
          Opišite željeni makeup, nokte ili stil i naš AI će kreirati viziju za
          vas.
        </p>
