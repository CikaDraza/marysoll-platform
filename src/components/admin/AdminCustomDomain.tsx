          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-shrink-0 px-4 py-2.5 bg-zinc-800 text-white text-sm font-semibold rounded-xl hover:bg-zinc-900 transition disabled:opacity-40 flex items-center gap-2"
              >
                {isSearchingDomain ? (
          ...
          <div className="flex flex-col gap-2">
            ...
            {hasDomain && !isVerified && (
              ...
              >
                ...
                {isVerifying ? "Provjera..." : "Proveri verifikaciju"}
              </button>
            )}
