...
export async function newsletterPromotionTemplate(data: {
      ...
      <tr>
        <td align="center">
          <p style="margin:0;font-size:11px;color:#c8b8d0;">
            <a href="${data.unsubscribeUrl}" style="color:#ff80b5;text-decoration:underline;">Otkaži pretplatu</a>
            &nbsp;·&nbsp;
            <a href="${appUrl()}/cookie-policy#open-preferences" style="color:#9089fc;text-decoration:underline;">Podesi preferencije</a>
          </p>
        </td>
      </tr>
    </table>
  ...
  return wrapEmailLayout({ title: data.subject, content: innerContent });
}
